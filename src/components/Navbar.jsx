        ...
        <div className=" menu flex items-center gap-4">
          ...
          <div className="container relative group text-center w-[54px] h-[50px] rounded-full flex items-center justify-center text-[24px] cursor-pointer">
            <a className="text-white text-[16px] flex items-center justify-center px-[12px] py-[8px] rounded-[5px] transition-colors duration-300 hover:bg-[rgba(10,147,150,0.8)]" href="#" aria-label="Notifications" id="notificationBtn">
                ...
                <span className="tooltip absolute top-[120%] left-1/2 transform-translate-x-1/2  bg-black bg-opacity-80 text-white p-[5px_10px] rounded text-[12px] whitespace-nowrap  opacity-0 invisible transition-opacity duration-300 ease-out group-hover:opacity-100 group-hover:visible">Notification</span>
                </a>
          </div>
          <div className="container relative group text-center w-[54px] h-[50px] rounded-full flex items-center justify-center text-[24px] cursor-pointer" id="profileBtn">
